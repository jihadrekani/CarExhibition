...
export default function Taxis() {
  const Cars = [
    ...
    image:" https://images.unsplash.com/photo-1560207218-c1f79592e215?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
    miles_per_Gallon:18,
    cylinders:8,
    displacement:307,
    horsepower:130,
...
{ id:11,
 ...
 {id: 12,
  ...
  return (
    <Layout>
      <h1 className=' container mt-5 text-center text-4xl font-semibold text-[#1f2937] font-serif '>Taxis Cars</h1>
