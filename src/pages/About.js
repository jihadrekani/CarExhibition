          ...
          <div className="flex flex-wrap -m-6">
            ...
            <div className="w-full md:w-1/2 p-6">
              <div className="md:max-w-md ml-auto">
                ...
                <ul>
                  <li className="mb-6 text-white hover:text-gray-300 text-2xl"><a href="https://www.facebook.com/jihad.rekani.33">Facebook</a></li>
                  <li className="mb-6 text-white hover:text-gray-300 text-2xl"><a href="https://twitter.com/JiHadJR10?t=_Xx3ig57mn2rivB_uTYn1A&s=09">Twitter</a></li>
                  <li className="mb-6 text-white hover:text-gray-300 text-2xl"><a href="https://www.linkedin.com/in/jihad-issa-618265197">Linkedin</a></li>
                  <li className="mb-6 text-white hover:text-gray-300 text-2xl"><a href="https://instagram.com/jihadissaa?igshid=YmMyMTA2M2Y=">Instagram</a></li>
                  <li className="text-white hover:text-gray-300 text-2xl"><a href="https://www.snapchat.com/add/jr_rekani?share_id=Sfj2M0jEv-Y&locale=en-IQ">Snapchat</a></li>
                </ul>
              </div>
            </div>
          </div>
