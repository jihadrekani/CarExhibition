...
export default function MultiSlider() {
  ...
  return (
    ...
    <h2 className='flex justify-center align-center mb-3 text-2xl font-bold'>New Deals <svg xmlns="http://www.w3.org/2000/svg" className=" h-6 w-6 mt-2 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
