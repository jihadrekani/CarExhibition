...
<div className='    w-[320px] h-[260px]   text-center   '>
  <h2 className='text-lg  text-white text-center font-sans bg-sky-700 rounded-xl mt-1  '>Search our extensive range of quality cars with prices to suit all budgets</h2>
